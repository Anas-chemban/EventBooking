...
SECRET_KEY = 'django-insecure-u-s%+w$d&e@ku#+slpp=q0iu_4+%@54@=e(_f(*3os!zh9$oj8'
...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(days=1),   # 👈 access token
...
EMAIL_HOST_USER = 'shanumollud@gmail.com'
EMAIL_HOST_PASSWORD = 'htogflyggzofinew'  # app password

DEFAULT_FROM_EMAIL = 'Event Booking <shanumollud@gmail.com>'
